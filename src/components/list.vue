  ...
  <div class="w-1/4">
    ...
    <ul class="pt-8 space-y-2">
      <li
        ...
        "
        class="w-full px-4 py-2 font-bold text-center text-gray-100 transition-colors duration-500 bg-gray-700 rounded-lg hover:border-dotted hover:border-4 hover:cursor-pointer hover:text-gray-200"
      >
        {{ todo.text }}
      </li>
    </ul>
